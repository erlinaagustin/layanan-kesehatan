                    ...
                    <?php $no = 1; ?>
                        <?php foreach($pasien as $item): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/data-pasien-admin/edit/<?php echo $item['ID_Pasien']; ?>"><i class='bx bxs-edit'></i></a>
                                    &nbsp;<!-- Menambahkan spasi -->
                                    <a href="/data-pasien-admin/delete/<?php echo $item['ID_Pasien']; ?>"><i class='bx bxs-trash' ></i></a>
                                </td>
